...
Route::group(['prefix' => '','as' => 'user.' ,'namespace' => 'User','middleware' => ['auth']], function () {
	...
	Route::post('list-complaints',array('uses'=>'ComplaintsController@list_complaints'));
	...
	Route::post('complaints/delete_complaint/{request_id}',array('uses'=>'ComplaintsController@complaint_delete')); //Edit User
