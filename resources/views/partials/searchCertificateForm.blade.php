 <form action="{{ url('certificates') }}" method="GET" id="searchCertificateForm" >
		@csrf
	<div class="row">
			...
			<div class="card-body">
				<div class="row">
					<div class=" col-md-6">
						<div class="row">
							...
							<div class="form-group col-lg-6">
								<select  id="covered_amount"  class="form-control select2-single"  name="covered_amount"  data-width="100%">
									<option value=" ">{{trans('global.filter_by_covered_amount')}}</option>
									@foreach(list_plans() as $plandata)
										<option value="{{$plandata->id}}">{{$plandata->insurance_cover}}</option>
									@endforeach
								</select>
							</div>
						</div>
				...
				<div class="row">
					<div class="form-group">
						...
						<button type="button" id="export_certificate_left" class="btn btn-primary default  btn-lg mb-2 mb-lg-0 col-12 col-lg-auto">Export Certificate Requests</button>
